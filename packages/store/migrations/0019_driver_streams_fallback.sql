...
-- fallback_cursor: next chain index to try; NULL read as 0.
-- fallback_log: append-only JSON array of hop/skip/retry records; NULL read as
--   empty. No record is written until P2a (engine hop); the column ships now so
--   the walk has nowhere new to migrate to later.
--
