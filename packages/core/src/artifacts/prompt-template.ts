...
export function renderImplementationPrompt(input: RenderImplementationPromptInput): string {
  ...
  return [
    ...
    "7. Before your final summary, commit your work:",
    "   - Stage only the production and test files you changed; exclude `task-doc.md` and any ephemeral files Ship created in the workdir.",
